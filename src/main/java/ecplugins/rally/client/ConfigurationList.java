    ...
    extends ListBase
{
    ...
    private RallyConfigList m_configList;

    //~ Constructors -----------------------------------------------------------

    public ConfigurationList()
    {
        super("ecgc", "Rally Configurations", "All Configurations");
        m_configList = new RallyConfigList();
    }
    ...
    @Override protected void load()
    {
        ...
        RallyConfigListLoader loader = new RallyConfigListLoader(m_configList, this,
                new ChainedCallback() {
    ...
    private void loadList()
    {
        ...
        if (!m_configList.isEmpty()) {
            listTable.addHeaderRow(true, "Configuration Name", "Server URL");
        }
        ...
        for (String configName : m_configList.getConfigNames()) {
            ...
            DialogClickHandler dch              = new DialogClickHandler(
                    new DeleteConfirmationDialog(configName,
                        "Are you sure you want to delete the Rally configuration '"
                            + configName + "'?") {
